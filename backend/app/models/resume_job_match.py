...
class ResumeJobMatch(Base):
    ...
    final_score: Mapped[Decimal] = mapped_column(DECIMAL(5, 2), nullable=False, default=Decimal("0.00"), comment="最终得分")
    final_label: Mapped[str] = mapped_column(String(20), nullable=False, default='未达标', comment="最终标签")
    ...
    is_direct_preferred: Mapped[int] = mapped_column(Integer, nullable=False, default=0, comment="是否直接优选")
