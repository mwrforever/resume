from sqlalchemy import Column, BigInteger, DECIMAL, DateTime, String, Text, Integer
...
class ResumeEvalDetail(Base):
    ...
    is_completed = Column(Integer, nullable=False, default=1, comment="是否成功完成评估：1成功，0失败")
